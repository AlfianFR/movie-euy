...
@section('content')
    <div class="page">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <figure><img src="{{ asset('template_front/dummy/figure.jpg') }}" alt="figure image"></figure>
                </div>
                <div class="col-md-8">
                    <p class="leading">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                        laudantium totam.</p>
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
                        totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae
                        dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit,
                        sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam
                        est, qui dolorem ipsum quia dolor sit consectetur adipisci velit, sed quia non numquam eius modi
                        tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam,
                        quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi
                        consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit consectetur adipisci velit, sed quia non
                        ...
                        dignissimos ducimus qui blanditiis praesentium voluptatum atque.</p>
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="team">
                        <figure class="team-image"><img src="{{ asset('template_front/dummy/person-1.jpg') }}"
                                alt=""></figure>
                ...
                <div class="col-md-3">
                    <div class="team">
                        <figure class="team-image"><img src="{{ asset('template_front/dummy/person-2.jpg') }}"
                                alt=""></figure>
                ...
                <div class="col-md-3">
                    <div class="team">
                        <figure class="team-image"><img src="{{ asset('template_front/dummy/person-3.jpg') }}"
                                alt=""></figure>
                ...
                <div class="col-md-3">
                    <div class="team">
                        <figure class="team-image"><img src="{{ asset('template_front/dummy/person-4.jpg') }}"
                                alt=""></figure>
                        <h2 class="team-name">Sarah Stuart</h2>
